...
set ylabel "diff R_n_t_c [-]" # offset -1
plot ntc_diff(x) title "" lc "blue" with lines #, "GegevensBetatherm10K3A542I.dat" using 3:4 with points pt 7 ps 0.2 lc "red" title "" 
