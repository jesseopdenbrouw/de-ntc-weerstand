...
\begin{equation}
\label{equ:transferh}
H(T) = \dfrac{U_O}{U_B} = \dfrac{R_S}{\rntc + R_S}=\dfrac{R_S}{A\cdot\text{e}^{\,(B/T)}+R_S}
\end{equation}
...
\begin{equation}
\label{equ:transferT}
T = \dfrac{B}{\ln (R_s - H\cdot R_S) - \ln (H\cdot A)} \qquad\qquad\text{met }H = \dfrac{U_0}{U_B}
\end{equation}
...
omdat de uitgang van de instrumentatie versterker niet tegen de voedingsspanningen
