...
\input{gnuplot/ntc_shh_straightline_curve_fitting_params}
\begin{table}[ht!]
\centering
\caption{Co\"effici\"enten van de functie voor $B$ bij temperatuur in graden Celsius en Kelvin.}
...
\begin{equation}
R_K = \epsilon\cdot R_G \qquad\qquad\text{of}\qquad\qquad \epsilon=\dfrac{R_K}{R_G}
\end{equation}
...
\begin{equation}
\dfrac{U_{O,max}}{U_B} - \dfrac{U_{O,min}}{U_B} = \dfrac{U_{O,max-U_{O,min}}}{U_B} =
...
We willen de temperatuur meten tussen \mathcelc{0} en \mathcelc{30}. In
...
bij \mathcelc{30}. We de kunnen nu de optimale serieweerstand uitrekenen:
\begin{equation}
R_{opt} = \sqrt{R_K\cdot R_G} = \sqrt{8056\cdot32650} = 16218\ \Omega
\end{equation}
...
U_{O,min} = \dfrac{\sqrt{\epsilon}}{1+\sqrt{\epsilon}}\cdot U_B =
          = \dfrac{0,4967}{1+0,4967}\cdot U_B = 0,3319\cdot U_B
\end{equation}
\begin{equation}
U_{O,max} = \dfrac{1}{1+\sqrt{\epsilon}}\cdot U_B =
          = \dfrac{1}{1+0,4967}\cdot U_B = 0,6681\cdot U_B
\end{equation}
De spanningsswing is:
\begin{equation}
U_{SWING} = \dfrac{1-\sqrt{\epsilon}}{1+\sqrt{\epsilon}}\cdot U_B =
          = \dfrac{1-0,4967}{1+0,4967}\cdot U_B = 0,3362\cdot U_B
\end{equation}
...
\lstinputlisting[linerange={1-34},caption=hallo,label=cod:ntc_shh_kelvin]{gnuplot/ntc_shh_kelvin.plt}

\label{app:ntc_shh_straightline_beta}
\lstinputlisting[linerange={1-34},caption=hallo,label=cod:ntc_shh_straightline_beta]{gnuplot/ntc_shh_straightline_beta.plt}

\label{app:ntc_shh_straightline}
\lstinputlisting[linerange={1-34},caption=hallo,label=cod:ntc_shh_straightline]{gnuplot/ntc_shh_straightline.plt}
